...
$_SESSION['imgurl']='img/'.$_FILES['image']['name']; //url dell'immagine

$url=$_SESSION['imgurl'];
$idimg=$_SESSION['idimm'];

print_r($_SESSION);

//$query=("UPDATE immutenti
//    SET urlimgutenti='$url'
//    WHERE idimmutenti='$idimg'");
//insData($query);


header('location:gestisciprofilo.php');
